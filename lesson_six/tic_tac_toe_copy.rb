...
def detect_winner(brd)
  if player_won?(brd) == 'Player'
    return 'Player'
  elsif computer_won?(brd) == 'Computer'
    return 'Computer'
  end
  nil
end
...
def determine_match_winner(player_wins, computer_wins)
  if player_wins >= 5
...
loop do
  ...
  loop do
    ...
    determine_match_winner(player_wins, computer_wins)
